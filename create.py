...
class OptionsGetter:
    ...
    def process_arguments_or_input(self) -> Tuple[str, str, str, str, str, str, str, str]:
        if self.arguments['non_interactive']:
            ...
            return input('Language: '), input('Faculty: '), input('Type: '), input('Subject: '), input(
                'Title: '), input('First Name: '), input('Last Name: '), input('Group: ')
...
class PDFGenerator:
    ...
    def get_options(self, options: Tuple[str, str, str, str, str, str, str, str]):
        ...
        self.information = ' '.join(
            [self.document_type, self.subject, self.title, self.first_name, self.last_name, self.group, self.template])
